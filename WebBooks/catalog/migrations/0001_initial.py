# Generated by Django 4.0 on 2021-12-23 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imprint', models.CharField(help_text='Издательство и год выпуска', max_length=200, verbose_name='Издательство')),
                ...
                ('status', models.ForeignKey(help_text='Состояние экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра')),
            ],
        ),
        migrations.AddField(
            model_name='book',
